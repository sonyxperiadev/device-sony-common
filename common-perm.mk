...
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/system_ext/etc/permissions/ims_permissions.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/ims_permissions.xml \
    $(COMMON_PATH)/rootdir/system_ext/etc/permissions/privapp-permissions-ims.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-ims.xml \
    $(COMMON_PATH)/rootdir/system_ext/etc/permissions/qcrilhook.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/qcrilhook.xml
