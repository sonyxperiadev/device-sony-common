...
QCOM_BOARD_PLATFORMS += sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA) $(HOLI) $(TARO) $(KALAMA) $(PARROT)
...
QCOM_NEW_MEDIA_PLATFORM := sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA)  $(HOLI) $(TARO) $(KALAMA) $(PARROT)

#List of targets that use master side content protection
MASTER_SIDE_CP_TARGET_LIST := sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA) $(HOLI) $(TARO) $(KALAMA) $(PARROT)
