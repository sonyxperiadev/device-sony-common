...
QCOM_BOARD_PLATFORMS += msm8998 sdm660 sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) sm8350
...
QCOM_NEW_MEDIA_PLATFORM := sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) sm8350

#List of targets that use video hw
MSM_VIDC_TARGET_LIST := msm8998 sdm660 sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) sm8350

#List of targets that use master side content protection
MASTER_SIDE_CP_TARGET_LIST := msm8998 sdm660 sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) sm8350
