...
QCOM_BOARD_PLATFORMS += sdm660 sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA)
...
QCOM_NEW_MEDIA_PLATFORM := sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA)

#List of targets that use video hw
MSM_VIDC_TARGET_LIST := sdm660 sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA)

#List of targets that use master side content protection
MASTER_SIDE_CP_TARGET_LIST := sdm660 sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA)
